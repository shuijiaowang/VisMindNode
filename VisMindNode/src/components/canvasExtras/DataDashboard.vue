...
<template>
  <div class="log">
    ...
    <div>组件数量: {{ elementStore.elMap.size}}</div>
    <div>视图范围内组件数量{{elementStore.visibleTitleIds.length+elementStore.visibleMarkdownIds.length}}</div>
